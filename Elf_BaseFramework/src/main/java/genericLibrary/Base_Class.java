...
public class Base_Class implements FrameworkConstants {
	...
	public void loginToApplication() {
		...
		Reporter.log("Product Naveen Is Created Successfully",true);
		
		Reporter.log(" the  Corporate work Schedule is downloaded succesfully",true);
		
		Reporter.log("Invited Message Is Displyed Succesfully",true);
}
//
